...
public class UsuarioPersistence implements IUsuarioPersistence {
    ...
    public void guardarUsuario(Usuario usuario) throws UcordPersistenceException {
        try {
            if (usuarioRepository.findByCorreo(usuario.getCorreo()) != null)
                throw new UcordPersistenceException(UcordPersistenceException.USER_ALREADY_EXISTS);
    ...
    public Usuario getUsuarioPorCorreo(String correo) throws UcordPersistenceException {
        ...
        optionalUsuario.orElseThrow(() -> new UcordPersistenceException(
                "The user with mail " + correo + " was " + UcordPersistenceException.NOT_FOUND));
    ...
    public List<Usuario> getAllUsuarios() throws UcordPersistenceException {
        ...
        if (query.size() == 0)
            throw new UcordPersistenceException(UcordPersistenceException.NOT_FOUND);
        return query;
    }
