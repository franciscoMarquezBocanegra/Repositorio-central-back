...
@RestController
@RequestMapping(value = "/repositorio-central/decanaturas")
@CrossOrigin(origins = "*") // es un protocolo estándar que define la interacción entre un navegador y un
                            // servidor para manejar de forma segura las solicitudes HTTP de origen cruzado.
